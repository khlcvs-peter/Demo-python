...
def drawlight():  # 定义画彩灯的方法
    if r.randint(0, 90) == 0:  # 如果觉得彩灯太多，可以把取值范围加大一些，对应的灯就会少一些
...
t.write("Merry Christmas 聖誕節快樂 ", align="center", font=("Comic Sans MS", 40, "bold"))  # 定义文字、位置、字体、大小
